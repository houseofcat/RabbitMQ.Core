...
namespace RabbitMQ.Client.Framing.Impl
{
    public class Connection : IConnection
    {
        ...
        private readonly ManualResetEvent m_appContinuation = new ManualResetEvent(false);
        ...
        private readonly IConnectionFactory m_factory;
        private readonly IFrameHandler m_frameHandler;

        private Guid m_id = Guid.NewGuid();
        private readonly ModelBase m_model0;
        private volatile bool m_running = true;
        private readonly MainSession m_session0;
        ...
        private readonly AutoResetEvent m_heartbeatRead = new AutoResetEvent(false);
