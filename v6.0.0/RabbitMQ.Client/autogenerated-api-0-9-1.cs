...
namespace RabbitMQ.Client.Framing
{
  internal sealed class Protocol : RabbitMQ.Client.Framing.Impl.ProtocolBase
  {
    ...
    public override Client.Impl.MethodBase DecodeMethodFrom(ReadOnlyMemory<byte> memory)
    {
    ...
    public override Client.Impl.ContentHeaderBase DecodeContentHeaderFrom(ushort classId)
    {
      switch (classId)
      {
  ...
  internal sealed class BasicProperties : RabbitMQ.Client.Impl.BasicProperties
  {
    ...
    public override void ReadPropertiesFrom(ref Client.Impl.ContentHeaderPropertyReader reader)
    {
    ...
    public override void WritePropertiesTo(ref Client.Impl.ContentHeaderPropertyWriter writer)
    {
