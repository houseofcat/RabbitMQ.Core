...
namespace RabbitMQ.Client.Apigen.Attributes
{
    ...
    internal class AmqpMethodDoNotImplementAttribute : AmqpApigenAttribute
    {
    ...
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    internal class AmqpAsynchronousHandlerAttribute : AmqpApigenAttribute
    {
    ...
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    internal class AmqpUnsupportedAttribute : AmqpApigenAttribute
    {
    ...
    ///in a reply.</summary>
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    internal class AmqpFieldMappingAttribute : AmqpApigenAttribute
    {
    ...
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    internal class AmqpMethodMappingAttribute : AmqpApigenAttribute
    {
    ...
    ///and control.</summary>
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    internal class AmqpNowaitArgumentAttribute : AmqpApigenAttribute
    {
